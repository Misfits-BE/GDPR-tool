            ...
            <div class="card card-body border-0 box-shadow">
                ...
                <form method="POST" action="{{ route('categories.store') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea @input('description') aria-describedby="descHelpBlock" id="description" class="form-control @error('description', 'is-invalid')" placeholder="Category description" rows="7"></textarea>
